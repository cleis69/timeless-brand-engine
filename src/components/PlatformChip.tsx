...
export const PLATFORMS: Platform[] = [
  { label: "Meta Ads", file: "meta.svg", wordmark: true, suffix: "Ads", height: 13 },
  { label: "Google Ads", file: "google-ads.svg", suffix: "Google Ads", height: 16 },
  { label: "TikTok Ads", file: "tiktok.svg", suffix: "TikTok Ads", height: 16 },
];

/** Disponibles si tu veux les ajouter ailleurs sur le site. */
export const PLATFORMS_EXTRA: Platform[] = [
  { label: "Instagram", file: "instagram.svg", suffix: "Instagram", height: 15 },
  { label: "WhatsApp", file: "whatsapp.svg", suffix: "WhatsApp", height: 16 },
];
    ...
    >
      {failed ? (
        ...
        <img
          ...
          style={{ height: platform.height ?? 16 }}
